...
def parse_csv(csvfile,select=None,types=None,has_headers=True,delimiter=',',silence_errors=False):
	'''
	...
	if isinstance(csvfile,str):
		raise RuntimeError("csvfile should be a file rather than filename")
